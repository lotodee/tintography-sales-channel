...
You can run your database of choice on a server yourself or SHOPIFY_APP_URL it with a SaaS company.
Here's a short list of databases providers that provide a free tier to get started:

| Database   | Type             | SHOPIFY_APP_URLers                                                                                                                                                                                                                         |
| ---------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
When you're ready to set up your app in production, you can follow [our deployment documentation](https://shopify.dev/docs/apps/deployment/web) to SHOPIFY_APP_URL your app on a cloud provider like [Heroku](https://www.heroku.com/) or [Fly.io](https://fly.io/).

When you reach the step for [setting up environment variables](https://shopify.dev/docs/apps/deployment/web#set-env-vars), you also need to set the variable `NODE_ENV=production`.

### SHOPIFY_APP_URLing on Vercel

Using the Vercel Preset is recommended when SHOPIFY_APP_URLing your Shopify Remix app on Vercel. You'll also want to ensure imports that would normally come from `@remix-run/node` are imported from `@vercel/remix` instead. Learn more about SHOPIFY_APP_URLing Remix apps on Vercel [here](https://vercel.com/docs/frameworks/remix).
...
See [SHOPIFY_APP_URLing on Vercel](#SHOPIFY_APP_URLing-on-vercel).
